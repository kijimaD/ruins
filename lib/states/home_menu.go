...
func (st *HomeMenuState) Update(world w.World) states.Transition {
	...
	// 完全回復
	effects.AddEffect(nil, effects.Healing{ValueType: gc.PercentageType, Ratio: float64(1.0)}, effects.Party{})
	effects.AddEffect(nil, effects.RecoveryStamina{ValueType: gc.PercentageType, Ratio: float64(1.0)}, effects.Party{})
